...
setup(
    name='powerlibs-django-contrib-sqs',
    version=version,
    description="Django models integration to SQS",
    long_description=readme,
    author='Cléber Zavadniak',
    author_email='cleberman@gmail.com',
    url='https://github.com/Dronemapp/powerlibs-django-contrib-sqs',
    license=license,
    packages=['powerlibs', 'powerlibs.django', 'powerlibs.django.contrib', 'powerlibs.django.contrib.sqs'],
